  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        class={cn(
          "group/sidebar-wrapper flex grow w-full text-sidebar-foreground has-[[data-variant=inset]]:bg-sidebar",
          local.class,
        )}
        {...others}
      >
    ...
    <Switch>
      ...
      <Match when={!isMobile()}>
        ...
        >
          ...
          <div
            class={cn(
              "relative flex grow w-[--sidebar-width] bg-transparent transition-[width] duration-200 ease-linear",
          ...
          <div
            class={cn(
              "absolute inset-y-0 z-10 hidden grow w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex",
              local.side === "left"
          ...
          >
            <div
              data-sidebar="sidebar"
              class="flex size-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow grow"
            >
              {local.children}
            </div>
          </div>
...
const SidebarTrigger = <T extends ValidComponent = "button">(props: SidebarTriggerProps<T>) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      class={cn("size-7 bg-white dark:bg-black", local.class)}
...
type SidebarInputProps<T extends ValidComponent = "input"> = ComponentProps<typeof TextField<T>>;
...
const SidebarContent: Component<ComponentProps<"div">> = (props) => {
  ...
  return (
    <div
      ...
      class={cn(
        "flex min-h-0 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden grow",
        local.class,
      )}
      {...others}
    />
